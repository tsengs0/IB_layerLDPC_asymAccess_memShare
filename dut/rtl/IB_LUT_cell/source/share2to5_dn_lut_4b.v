...
* # Remark
        ...
        Logic LUT: 0 (PRELOAD_SET_NUM=2); 54  (PRELOAD_SET_NUM=1) 
        LUTRAM: ?   (PRELOAD_SET_NUM=2); 54 (PRELOAD_SET_NUM=1)
		FF: 0        (PRELOAD_SET_NUM=2); 0  (PRELOAD_SET_NUM=1) 
        I/O: ?      (PRELOAD_SET_NUM=2); 62 (PRELOAD_SET_NUM=1) 
        Freq: 400MHz
        WNS:  ns
        TNS:  ns
        WHS:  ns
        ...
        TPWS: ns
**/
module share2to5_dn_lut_4b #(
    // Basic configuration of memory cells
    parameter QUAN_SIZE = 1,
    parameter BANK_INTERLEAVE = 1,
    parameter PRELOAD_SET_NUM = 1, //! The number of preload sets stored in the underlying memory cell
    parameter GP1_RD_ADDR_WIDTH = 6,
    parameter GP1_WR_ADDR_WIDTH = 6,
    parameter GP1_WR_WIDTH = QUAN_SIZE*BANK_INTERLEAVE,
    parameter GP1_ENTRY_NUM = (16*4*1), //! To merge decomposed 2-input IB-LUT f0 and f1
    parameter GP2_RD_ADDR_WIDTH = 7,
    parameter GP2_WR_ADDR_WIDTH = 7,
    parameter GP2_WR_WIDTH = QUAN_SIZE*BANK_INTERLEAVE,
    parameter GP2_ENTRY_NUM = (16*8*1), //! To merge decomposed 2-input IB-LUT f0 and f1
