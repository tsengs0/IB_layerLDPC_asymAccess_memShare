...
module share2to5_dn_lut_3b #(
    ...
    parameter GP1_ENTRY_NUM = (8*2*1), // To merge decomposed 2-input IB-LUT f0 and f1
    parameter GP2_RD_ADDR_WIDTH = 5,
    parameter GP2_WR_ADDR_WIDTH = 5,
    parameter GP2_WR_WIDTH = QUAN_SIZE*BANK_INTERLEAVE,
    parameter GP2_ENTRY_NUM = (8*4*1), // To merge decomposed 2-input IB-LUT f0 and f1
