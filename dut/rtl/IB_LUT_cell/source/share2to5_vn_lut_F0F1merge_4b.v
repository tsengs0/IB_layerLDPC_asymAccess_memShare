...
*
* # Remark
		LUT: ?      (PRELOAD_SET_NUM=2); 84 (PRELOAD_SET_NUM=1) 
        Logic LUT: 0 (PRELOAD_SET_NUM=2); 0  (PRELOAD_SET_NUM=1) 
        LUTRAM: ?   (PRELOAD_SET_NUM=2); 84 (PRELOAD_SET_NUM=1)
		FF: 0        (PRELOAD_SET_NUM=2); 0  (PRELOAD_SET_NUM=1) 
        I/O: ?      (PRELOAD_SET_NUM=2); 67 (PRELOAD_SET_NUM=1) 
        Freq: 400MHz
        WNS:  ns
        TNS:  ns
        WHS:  ns
        ...
        TPWS: ns
**/
module share2to5_vn_lut_F0F1merge_4b #(
    // Basic configuration of memory cells
    ...
    parameter GP1_RD_ADDR_WIDTH = 7,
    parameter GP1_WR_ADDR_WIDTH = 7,
    parameter GP1_WR_WIDTH = QUAN_SIZE*BANK_INTERLEAVE,
    parameter GP1_ENTRY_NUM = (16*4*2), //! To merge decomposed 2-input IB-LUT f0 and f1
    parameter GP2_RD_ADDR_WIDTH = 8,
    parameter GP2_WR_ADDR_WIDTH = 8,
    parameter GP2_WR_WIDTH = QUAN_SIZE*BANK_INTERLEAVE,
    parameter GP2_ENTRY_NUM = (16*8*2), //! To merge decomposed 2-input IB-LUT f0 and f1
