...
* Module name: columnMultiSrc_L1Route
...
`endif
// Stride unit 3
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit3_shared_sw_in_u0 (.sw_out(shared_sw_in_bit[/*strideUnit_3*/3][0]), .sw_in_0(stride3_in0_bit0_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride3_in1_bit0_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit3_shared_sw_in_u1 (.sw_out(shared_sw_in_bit[/*strideUnit_3*/3][1]), .sw_in_0(stride3_in0_bit1_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride3_in1_bit1_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit3_shared_sw_in_u2 (.sw_out(shared_sw_in_bit[/*strideUnit_3*/3][2]), .sw_in_0(stride3_in0_bit2_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride3_in1_bit2_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
`ifdef DECODER_4bit
  scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit3_shared_sw_in_u3 (.sw_out(shared_sw_in_bit[/*strideUnit_3*/3][3]), .sw_in_0(stride3_in0_bit3_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride3_in1_bit3_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
`endif
...
`endif
// Stride unit 4
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit4_shared_sw_in_u0 (.sw_out(shared_sw_in_bit[/*strideUnit_4*/4][0]), .sw_in_0(stride4_in0_bit0_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride4_in1_bit0_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit4_shared_sw_in_u1 (.sw_out(shared_sw_in_bit[/*strideUnit_4*/4][1]), .sw_in_0(stride4_in0_bit1_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride4_in1_bit1_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit4_shared_sw_in_u2 (.sw_out(shared_sw_in_bit[/*strideUnit_4*/4][2]), .sw_in_0(stride4_in0_bit2_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride4_in1_bit2_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
`ifdef DECODER_4bit
  scalable_mux #(.BITWIDTH(STRIDE_UNIT_SIZE)) strideUnit4_shared_sw_in_u3 (.sw_out(shared_sw_in_bit[/*strideUnit_4*/4][3]), .sw_in_0(stride4_in0_bit3_i[STRIDE_UNIT_SIZE-1:0]), .sw_in_1(stride4_in1_bit3_i[STRIDE_UNIT_SIZE-1:0]), .in_src(sw_in_src));
`endif
